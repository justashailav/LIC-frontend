  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meet your trusted LIC advisor in Jharkhand. 11+ years experience, 200+ happy clients, personalized insurance and claim support assistance."
        />
        <meta
          name="keywords"
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeRight}>
              ...
              <p className="text-gray-600 text-lg mb-6">
                With years of experience as an LIC advisor, I have been
                committed to helping individuals and families make informed
                financial decisions. My goal is to provide clear guidance,
                honest advice, and customized insurance solutions that align
                perfectly with your long-term financial goals and
                responsibilities.
              </p>
