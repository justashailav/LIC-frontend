...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Tejkavi Future Insurance | Trusted LIC Advisor in Jharkhand
        </title>
        ...
        <meta
          property="og:title"
          content="Tejkavi Future Insurance - LIC Advisor"
        />
        ...
        <section className="bg-gradient-to-r from-blue-50 to-blue-100 px-4 sm:px-6 py-16 md:px-20 md:py-20">
          ...
          >
            ...
            >
              ...
              >
                Secure Your Family’s <br className="hidden sm:block" />{" "}
